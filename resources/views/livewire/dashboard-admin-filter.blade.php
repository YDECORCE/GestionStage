          ...
          <tbody>
              ...
              @foreach ($trainees as $data)
                  ...
                  <td class="d-flex">
                      ...
                      <button type="button" class="btn btn-danger mx-3" onclick="document.getElementById('modal-open-{{$data->id}}').style.display='block'">Supprimer</button>
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                ...
                                <button type="button" class="close" data-dismiss="modal" onclick="document.getElementById('modal-open-{{$data->id}}').style.display='none'" aria-label="Close">
                                  <span aria-hidden="true">&times;</span>
                                </button>
                              </div>
                              <div class="modal-body">
                                <p>Etes-vous sûr de vouloir supprimer ce stagiaire ?</p>
                                <h4>L'ensemble des données concernant ce stagiaire : compte USER, Skills, Journal de stage seront DEFINITIVEMENT SUPPRIMEES!!!</h4>
                              </div>
                              <div class="modal-footer">
                                <button type="submit" class="btn btn-danger">oui</button>
                                <button type="button" class="btn btn-secondary" data-dismiss="modal" onclick="document.getElementById('modal-open-{{$data->id}}').style.display='none'">Annuler</button>
                              </div>
                            </div>
                          </div>
                        </div>
